...
function ready() {
  ...
  if (drophere) {
    ...
    var uniqueSecret = document.querySelector("input[name='uniqueSecret']").value;
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return fetch("/announcement/images/".concat(uniqueSecret), {
                    method: "GET",
                    headers: {
    ...
    myDropzone.on("removedfile", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(file) {
        var response;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fetch("/announcement/images/remove", {
                  method: "DELETE",
                  headers: {
                    "Content-Type": "application/json"
                  },
